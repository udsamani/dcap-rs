...
fn validate_tcbinforoot(tcb_info_root: &TcbInfoV2, root_verifying_key: &VerifyingKey, current_time: u64) -> bool {
...
pub fn get_tcbrootinfo_tcb_status(sgx_extensions: &SgxExtensions, tcb_info_root: &TcbInfoV2) -> TcbStatus {
